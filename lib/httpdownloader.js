...
var HttpDownloader = function(config){
	...
	function onDataHandler(data){
		...
		self.emit('data',data,{ url: url, resSize: resSize, dataSize: dataSize, resChunkSize: resChunkSize });
	};
	...
	function onFinishHandler(){
		...
		self.emit('end',data,{ url: url, resSize: resSize, dataSize: dataSize, resChunkSize: resChunkSize });
	};
